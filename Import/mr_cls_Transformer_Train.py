...
Class for training a new ktrain Distilbert Transformer.
...
class MR_transformer:
    ...
    def mr_train(self, train_df, val_df=None):
        ...
        if val_df is not None:
            ...
            # Get the actual classifier
            model = self.mr_t.get_classifier()
            learner = ktrain.get_learner(model, train_data=train_data, batch_size=self.batch_size)            
